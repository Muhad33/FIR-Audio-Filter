// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_audio_filter_biquad\Audio_Filter_IP_src_Biquad_Filter_BPF.v
...
// -------------------------------------------------------------
// 
// Module: Audio_Filter_IP_src_Biquad_Filter_BPF
// Source Path: hdlcoder_audio_filter_biquad/Audio_Filter/Filter_block/BiQuad_BPF /Biquad Filter BPF
// Hierarchy Level: 3
// Model version: 10.1
// 
// -------------------------------------------------------------
...
module Audio_Filter_IP_src_Biquad_Filter_BPF
          (clk,
           reset,
           enb,
           Biquad_Filter_BPF_In,
           Enable_out2,
           Biquad_Filter_BPF_out);


  input   clk;
  input   reset;
  input   enb;
  input   signed [23:0] Biquad_Filter_BPF_In;  // sfix24_En22
  input   Enable_out2;
  output  signed [23:0] Biquad_Filter_BPF_out;  // sfix24_En22


  reg signed [23:0] Biquad_Filter_BPF_In_1;  // sfix24_En22
  ...
  wire signed [33:0] b1_sec7_1;  // sfix34_En31
  ...
  reg signed [23:0] input_delay2_sec7_2;  // sfix24_En22
  wire signed [17:0] kconst_26;  // sfix18_En16
  reg signed [17:0] kconst_27;  // sfix18_En16
  wire signed [41:0] b2_sec7_1;  // sfix42_En38
  reg signed [39:0] delayMatch_reg_12 [0:1];  // sfix40 [2]
  wire signed [39:0] delayMatch_reg_next_12 [0:1];  // sfix40_En31 [2]
  wire signed [39:0] sum_b1_sec7_2;  // sfix40_En31
  reg signed [41:0] b2_sec7_2;  // sfix42_En38
  wire signed [33:0] b2_sec7_3;  // sfix34_En31
  ...
  always @(posedge clk)
    begin : HwModeRegister_process
      if (reset == 1'b1) begin
        Biquad_Filter_BPF_In_1 <= 24'sb000000000000000000000000;
      end
      else begin
        if (enb) begin
          Biquad_Filter_BPF_In_1 <= Biquad_Filter_BPF_In;
        end
      end
    end

  assign kconst = 18'sb010010010010100000;
  ...
  assign scale_sec1_1 = Biquad_Filter_BPF_In_1 * kconst_1;
  always @(posedge clk)
  ...
  assign a1_sec1_mul_temp = 18'sb111000110100011100 * input_delay1_sec1;
  ...
  assign a2_sec1_mul_temp = 18'sb001110001110110100 * input_delay2_sec1_1;
  ...
  assign kconst_2 = 18'sb100101101110111000;
  ...
  assign kconst_4 = 18'sb010010010010100000;
  ...
  assign a1_sec2_mul_temp = 18'sb101001111100001000 * input_delay1_sec2;
  ...
  assign a2_sec2_mul_temp = 18'sb001110101101101000 * input_delay2_sec2_1;
  ...
  assign kconst_6 = 18'sb000000011011001100;
  ...
  assign kconst_8 = 18'sb001110111111110100;
  ...
  assign a1_sec3_mul_temp = 18'sb101100001000110000 * input_delay1_sec3;
  ...
  assign a2_sec3_mul_temp = 18'sb001100001011110000 * input_delay2_sec3_1;
  ...
  assign kconst_10 = 18'sb100100100011000100;
  ...
  assign kconst_12 = 18'sb001110111111110100;
  ...
  assign a1_sec4_mul_temp = 18'sb111000111000111100 * input_delay1_sec4;
  ...
  assign a2_sec4_mul_temp = 18'sb001011000001100000 * input_delay2_sec4_1;
  ...
  assign kconst_14 = 18'sb000100011010110100;
  ...
  assign kconst_16 = 18'sb001010110011011000;
  ...
  assign a1_sec5_mul_temp = 18'sb101111010010110100 * input_delay1_sec5;
  ...
  assign a2_sec5_mul_temp = 18'sb001001100011101100 * input_delay2_sec5_1;
  ...
  assign kconst_18 = 18'sb100010000010010100;
  ...
  assign kconst_20 = 18'sb001010110011011000;
  ...
  assign a1_sec6_mul_temp = 18'sb110111011110111100 * input_delay1_sec6;
  ...
  assign a2_sec6_mul_temp = 18'sb001000011000111000 * input_delay2_sec6_1;
  ...
  assign kconst_22 = 18'sb010000010010110000;
  ...
  assign kconst_24 = 18'sb001000010100010100;
  ...
  assign a1_sec7_mul_temp = 18'sb110011101111011100 * input_delay1_sec7;
  ...
  assign a2_sec7_mul_temp = 18'sb000111101011101100 * input_delay2_sec7_1;
  ...
  assign b1_sec7_1 = 34'sh000000000;
  assign cast_b1_sec7_1 = {{6{b1_sec7_1[33]}}, b1_sec7_1};
  assign sum_b1_sec7_add_cast = {cast_b0_sec7_1[39], cast_b0_sec7_1};
  ...
  always @(posedge clk)
    begin : HwModeRegister_26_process
      if (reset == 1'b1) begin
        input_delay2_sec7_2 <= 24'sb000000000000000000000000;
      end
      else begin
        if (enb) begin
          input_delay2_sec7_2 <= input_delay2_sec7_1;
        end
      end
    end

  assign kconst_26 = 18'sb110000000000000000;
  ...
  assign b2_sec7_1 = input_delay2_sec7_2 * kconst_27;
  always @(posedge clk)
  ...
  assign sum_b1_sec7_2 = delayMatch_reg_12[1];
  assign delayMatch_reg_next_12[0] = sum_b1_sec7_1;
  assign delayMatch_reg_next_12[1] = delayMatch_reg_12[0];

  always @(posedge clk)
    begin : PipelineRegister_13_process
      if (reset == 1'b1) begin
        b2_sec7_2 <= 42'sh00000000000;
      end
      else begin
        if (enb) begin
          b2_sec7_2 <= b2_sec7_1;
  ...
  assign b2_sec7_3 = ((b2_sec7_2[41] == 1'b0) && (b2_sec7_2[40] != 1'b0) ? 34'sh1FFFFFFFF :
              ((b2_sec7_2[41] == 1'b1) && (b2_sec7_2[40] != 1'b1) ? 34'sh200000000 :
              $signed(b2_sec7_2[40:7])));

  assign cast_b2_sec7_1 = {{6{b2_sec7_3[33]}}, b2_sec7_3};
  assign sum_b2_sec7_add_cast = {sum_b1_sec7_2[39], sum_b1_sec7_2};
  assign sum_b2_sec7_add_cast_1 = {cast_b2_sec7_1[39], cast_b2_sec7_1};
  ...
  assign Biquad_Filter_BPF_out = ((sum_b2_sec7_1[39] == 1'b0) && (sum_b2_sec7_1[38:32] != 7'b0000000) ? 24'sb011111111111111111111111 :
              ((sum_b2_sec7_1[39] == 1'b1) && (sum_b2_sec7_1[38:32] != 7'b1111111) ? 24'sb100000000000000000000000 :
              $signed(sum_b2_sec7_1[32:9])));
endmodule  // Audio_Filter_IP_src_Biquad_Filter_BPF
