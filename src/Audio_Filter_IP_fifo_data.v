// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_audio_filter_biquad\Audio_Filter_IP_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: Audio_Filter_IP_fifo_data
// Source Path: Audio_Filter_IP/Audio_Filter_IP_axi4_stream_slave/Audio_Filter_IP_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Audio_Filter_IP_fifo_data
  ...
  Audio_Filter_IP_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                            ...
                                            u_Audio_Filter_IP_fifo_data_classic_ram (.clk(clk),
                                                                                     .enb(enb),
                                                                                     .wr_din(In),
                                                                                     .wr_addr(w_waddr),
                                                                                     .wr_en(w_we),  // ufix1
...
endmodule  // Audio_Filter_IP_fifo_data
