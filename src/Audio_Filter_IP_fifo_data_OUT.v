// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_audio_filter_biquad\Audio_Filter_IP_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Audio_Filter_IP_fifo_data_OUT
// Source Path: Audio_Filter_IP/Audio_Filter_IP_axi4_stream_master/Audio_Filter_IP_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Audio_Filter_IP_fifo_data_OUT
  ...
  input   reset;
  input   enb;
  input   [47:0] In;  // ufix48
  input   Push;  // ufix1
  input   Pop;  // ufix1
  output  [47:0] Out;  // ufix48
  output  Empty;  // ufix1
  output  AFull;  // ufix1
  ...
  wire w_mux1;  // ufix1
  reg  w_d1;  // ufix1
  wire [47:0] w_waddr_1;  // ufix48
  reg [47:0] w_d2;  // ufix48
  wire [47:0] w_out;  // ufix48
  reg [47:0] cache_data;  // ufix48
  wire [47:0] data_out_next;  // ufix48
  reg [47:0] Out_1;  // ufix48
  ...
  Audio_Filter_IP_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                              .DataWidth(48)
                                              )
                                            u_Audio_Filter_IP_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                                 .enb(enb),
                                                                                                 .wr_din(In),
                                                                                                 .wr_addr(w_waddr),
                                                                                                 .wr_en(w_we),  // ufix1
...
endmodule  // Audio_Filter_IP_fifo_data_OUT
