// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_audio_filter_biquad\Audio_Filter_IP_fifo_TLAST_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Audio_Filter_IP_fifo_TLAST_OUT
// Source Path: Audio_Filter_IP/Audio_Filter_IP_axi4_stream_master/Audio_Filter_IP_fifo_TLAST_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Audio_Filter_IP_fifo_TLAST_OUT
  ...
  Audio_Filter_IP_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                                .DataWidth(1)
                                                )
                                              u_Audio_Filter_IP_fifo_TLAST_OUT_classic_ram_singlebit (.clk(clk),
                                                                                                      .enb(enb),
                                                                                                      .wr_din(In),  // ufix1
                                                                                                      .wr_addr(w_waddr),
                                                                                                      .wr_en(w_we),  // ufix1
...
endmodule  // Audio_Filter_IP_fifo_TLAST_OUT
